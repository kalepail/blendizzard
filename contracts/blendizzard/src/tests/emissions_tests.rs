...
fn test_update_reserve_token_ids() {
    ...
    client.update_config(&None, &None, &None, &None, &None, &Some(new_reserve_ids), &None, &None, &None);
...
fn test_multiple_reserve_token_ids() {
    ...
    client.update_config(&None, &None, &None, &None, &None, &Some(multi_reserve_ids), &None, &None, &None);
...
fn test_empty_reserve_token_ids() {
    ...
    client.update_config(&None, &None, &None, &None, &None, &Some(empty_reserve_ids), &None, &None, &None);
